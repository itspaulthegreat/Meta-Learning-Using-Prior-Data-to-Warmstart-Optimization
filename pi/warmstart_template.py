...
if __name__ == "__main__":
    ...
    # acquisition = HyperparameterOptimizationFacade.get_acquisition_function(scenario=scenario, xi=1.00)
    acquisition = HyperparameterOptimizationFacade.get_acquisition_function(scenario=scenario, xi=1.00)
    # Change the acquisition maximiser function
    # acquisition_maximiser = DifferentialEvolution(scenario.configspace,
